...
![AgriProduct](/frontend/public/images/AgriProduct.jpg)
...
- 👉 Render : [https://AgriProduct.onrender.com](https://AgriProduct.onrender.com)
...
```
$ git clone git@github.com:basir/mern-AgriProduct.git
$ cd mern-AgriProduct
```
